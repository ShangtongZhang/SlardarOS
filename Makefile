...
KERNEL_INC_DIR := .
KERNEL_LIB_DIR := .
KERNEL_DIR := kernel/init kernel/memoryManage kernel/io kernel/utils
...
.PHONY: qemu debug os bootSector bootLoader osImage clean kernel start osImageImpl osComps
