...
gdbCmdFile.write('b virtualMemory.cpp:22\n')
gdbCmdFile.write('b virtualMemory.cpp:12\n')
# gdbCmdFile.write('b plainPagePool.hpp:32\n')
# gdbCmdFile.write('b plainVMController.hpp:93\n')
